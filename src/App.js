    ...
    <div className="App container-fluid">
      ...
      <div className="d-flex justify-content-center pt-5">
        <div className="p-3 rounded-2" style={bgStyle}>
          ...
          {user?.name && (
            <div>
              <Router>
                {/* <div className="d-flex justify-content-center align-items-center">
                  <img
                    src={user.image}
                    width="30px"
                    className="img-fluid rounded-pill border border-white border-1 me-2"
                    alt={user.name}
                  /> */}
              ...
              <div className="bg-white p-3 rounded text-dark fw-bold my-2">
                {user?.email && <p>You're registered with {user.email}</p>}
          ...
          {!user?.name && (
            <div>
              <Button
                ...
                variant="danger fw-bold border-white shadow"
              >
                <i className="fab fa-google"></i>oogle Sign-In
              </Button>
              <Button
                onClick={handleGithubSignIn}
                variant="secondary fw-bold border-white shadow ms-2"
              >
                <i className="fab fa-github"></i> Github Sign-In
              </Button>
            </div>
          )}
          ...
          {/* log-out */}
          {user?.name && (
            <Button onClick={logOut} variant="warning fw-bold ms-1 shadow">
              Log-Out
            </Button>
          )}
        </div>
